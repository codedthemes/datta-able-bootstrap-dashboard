...
gulp.task('build', function () {
  var required_libs = {
    ...
    css: ['node_modules/bootstrap/dist/css/bootstrap.min.css', 'node_modules/jsvectormap/dist/jsvectormap.min.css']
  };
...
gulp.task('uglify', function () {
  var layoutjs = gulp.src('src/assets/js/*.js').pipe(uglify()).pipe(gulp.dest('dist/assets/js'));

  var pagesjs = gulp.src('src/assets/js/pages/*.js').pipe(babel()).pipe(uglify()).pipe(gulp.dest('dist/assets/js/pages'));
...
gulp.task('imgmin', function () {
  return gulp.src('src/assets/img/**/*.{jpg,png}').pipe(smushit()).pipe(gulp.dest('dist/assets/img'));
});
//  [ image optimizer ] end
...
//  [ Default task ] start
gulp.task('default', gulp.series('cleandist', 'build', 'sass', 'build-js', 'build-html', 'imgmin', compile));
//  [ Default task ] end
// build in production mode
gulp.task('build-prod', gulp.series('cleandist', 'build', 'sass', 'build-js', 'build-html', 'imgmin'));
